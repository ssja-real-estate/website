...
import EditEstateSideBar from "../../components/EditEstate/EditEstateSideBar";
const EditEstate: NextPage = () => {
      ...
      <div className="mt-0 sm:mt-0 h-screen">
        <div className="flex flex-row h-full">
          <div className="hidden md:block">
            <EditEstateSideBar setCore={setCordinate} onSetEstate={setEstate} />
          </div>
