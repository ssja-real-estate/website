...
function EditConditionalField() {
    ...
    return (
        <>
            <ListGroup>
                {innerFieldModalData.fields?.map(
            ...
            <CustomModal
                ...
                handleSuccess={() => {
                    if (editSelectFieldModalData!.options!.length > 1) {
                        ...
                        alert(
                            "لطفاً حداقل دو گزینه برای ورودی جدید انتخاب کنید"
                        );
                    }
                }}
            >
                <div className="w-100 d-flex flex-row justify-content-center">
                    <div className="d-flex flex-column justify-content-center gap-2 pt-3">
                        <InputGroup style={{ direction: "ltr" }}>
                            <Button
                                ...
                                onClick={() => {
                                    if (newOptionTitle.trim() !== "") {
                                        const options =
                                            editSelectFieldModalData?.options!;
                                        const newOptions = [
                                            ...options,
                                            newOptionTitle,
                                        ];
                        ...
                        <ListGroup>
                            {editSelectFieldModalData?.options?.map(
                                (option, optionIndex) => {
                                    return (
                                        <ListGroup.Item
                                            key={optionIndex}
